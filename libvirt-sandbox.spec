...
# Source0-md5:	01df5ac5e56c73523b046179048657d6
...
Requires:	libvirt-glib-devel >= 0.0.8
...
%attr(755,root,root) %ghost %{_libdir}/libvirt-sandbox-1.0.so.0
